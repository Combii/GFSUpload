import { Component, ElementRef, HostListener, HostBinding, Input, EventEmitter, Renderer2, InjectionToken, Directive, ComponentFactoryResolver, ApplicationRef, Injector, Output, Inject, Optional, NgModule } from '@angular/core';
...
const _c0 = function (a0) { return { "tooltip-arrow": a0 }; };
function TooltipComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "div", 4);
    ɵngcc0.ɵɵtemplate(1, TooltipComponent_div_1_ng_container_1_Template, 1, 0, "ng-container", 5);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(2, _c0, ctx_r1.isThemeLight));
    ɵngcc0.ɵɵadvance(1);
...
TooltipComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TooltipComponent, selectors: [["tooltip"]], hostAttrs: [1, "tooltip"], hostVars: 20, hostBindings: function TooltipComponent_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { show: "show", data: "data" }, decls: 4, vars: 3, consts: [["class", "tooltip-arrow", 4, "ngIf"], [3, "ngClass", 4, "ngIf", "ngIfElse"], ["htmlOrStringTemplate", ""], [1, "tooltip-arrow"], [3, "ngClass"], [4, "ngTemplateOutlet"], [3, "innerHTML"]], template: function TooltipComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, TooltipComponent_div_0_Template, 1, 0, "div", 0);
        ɵngcc0.ɵɵtemplate(1, TooltipComponent_div_1_Template, 2, 4, "div", 1);
